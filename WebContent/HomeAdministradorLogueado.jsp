					...
					<tbody>
						...
						<tr>
							...
							<%
								...
								{
								%>
									<a href="ServletOdontograma?ClienteDNI=<%=Usu.getU_DNI()%>">Odontograma</a></td>
								<%
								}
							%>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalRegistroLabel">Modificar
						Usuario</h5>
				...
				<div class="modal-body">
					<form action="ServletUsuario" Method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="Modificar_DNI"
								readonly name="Modificar_DNI" placeholder="DNI">
						</div>
						<div class="form-group">
							<!-- <label for="appointment_name" class="text-black">Full Name</label> -->
							<input type="text" class="form-control" id="Modificar_nombre"
								readonly name="Modificar_nombre" placeholder="Nombre">
						</div>

						<div class="form-group">
							<!-- <label for="appointment_name" class="text-black">Full Name</label> -->
							<input type="text" class="form-control" id="Modificar_apellido"
								readonly name="Modificar_apellido" placeholder="Apellido">
						</div>
						<div class="form-group">
							<!-- <label for="appointment_name" class="text-black">Full Name</label> -->
							<input type="text" class="form-control" id="Modificar_telefono"
								readonly name="Modificar_telefono" placeholder="Telefono">
						</div>
						<%
							ArrayList<clsTipoUsuario> tiposUS = Usuariodao.TipoUsuario_TraerTodos();
						%>
						<div class="form-group">
							Tipo &nbsp; &nbsp; &nbsp; <select id="Modificar_Tipo"
								name="Modificar_Tipo" class="form-control">
								<%
									for (clsTipoUsuario Tipo : tiposUS) {
								%>
								<option value="<%=Tipo.getU_Id()%>">
									<%=Tipo.getU_Detalle()%>
								</option>
								<%
									}
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="Modificar_email"
								readonly name="Modificar_email" placeholder="Email">
						</div>
						<div class="form-group">
							<input type="submit" value="Aceptar" name="btnModificar"
